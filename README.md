...
> **💡 使用说明**：
> 由于 GitHub 限制大文件上传，**编译好的依赖库、整合包及模型下载指引**已存放于网盘。
> - 📥 **网盘链接**：ttps://pan.quark.cn/s/e1ed3149b140?pwd=fYFb
> - 🔑 **提取码**：fYFb
> - ⚠️ **注意**：网盘资源仅供学习交流，若链接失效，请参考下方“手动编译指南”自行构建。
...
## ⚖️ 免责声明
- 本项目所有成果仅用于**个人学习与研究**。
- Qwen3.5 模型版权归阿里巴巴所有，请下载官方正版模型。
- 修改后的 `llama-cpp-python` 源码遵循原项目 MIT 协议。
- 网盘资源由个人维护，不保证永久有效，建议使用手动编译方式以获得最新支持。
